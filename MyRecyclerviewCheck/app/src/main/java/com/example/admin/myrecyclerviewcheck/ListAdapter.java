package com.example.admin.myrecyclerviewcheck;
...
public class ListAdapter  extends RecyclerView.Adapter<ListAdapter.ViewHolder> implements View.OnClickListener,View.OnLongClickListener{
